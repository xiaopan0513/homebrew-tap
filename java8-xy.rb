cask 'java8Xy' do
  ...
  url "http://bucket.oa.com/download/dco-source//#{version.minor}u#{version.before_comma.split('_').last}/#{version.after_comma}/jdk-#{version.minor}u#{java_update}-macosx-x64.dmg"
